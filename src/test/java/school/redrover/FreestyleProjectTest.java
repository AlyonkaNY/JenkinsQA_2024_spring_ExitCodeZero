...
public class FreestyleProjectTest extends BaseTest {
    ...
    @Test
    public void testCreateNewJobPlusIconNavigatesToNewJobPage() {
    ...
    @Test(dependsOnMethods = "testCreateNewJobPlusIconNavigatesToNewJobPage")
    public void testCreateFreestyleProject() {
        ...
        List<WebElement> jobs = getDriver().findElements(By.xpath("//table[@id='projectstatus']"));
